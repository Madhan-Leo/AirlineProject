...
describe('Update Flight Component', () => {
  beforeEach(() => {
...
it(`should have as title 'Update Flight Component'`, () => {
  const fixture = TestBed.createComponent(UpdateFlightComponent);
  const app = fixture.componentInstance;
  expect(app.title).toEqual('UpdateFlightComponent');
});




it('Update Flight Component Test', () => {
  const fixture = TestBed.createComponent(UpdateFlightComponent);
...
it('Update Flight Form GUI count', () => {
  const fixture = TestBed.createComponent(UpdateFlightComponent);
...
it('Testing Update Flight Form valid', () => {
  const fixture = TestBed.createComponent(UpdateFlightComponent);
  const Flight = fixture.componentInstance;
